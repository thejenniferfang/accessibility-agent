    ...
    <div className="min-h-screen text-gray-900 relative overflow-hidden">
      <header className={`absolute top-0 left-0 w-full px-4 pt-4 md:pt-6 pb-2 flex items-center justify-between z-[60] ${isPanelOpen ? 'hidden md:flex' : 'flex'}`}>
        ...
        <button
          ...
          className={`min-h-11 min-w-11 px-3 py-2.5 rounded-xl transition-all flex items-center gap-2 font-medium ${
            isPanelOpen 
      ...
      <main className="container mx-auto py-8 md:py-12 px-4 relative z-10 flex flex-col items-center justify-center min-h-screen">
        ...
        <div className="w-full max-w-3xl px-4 md:px-0 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150 fill-mode-backwards">
